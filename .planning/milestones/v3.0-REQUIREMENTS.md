<!--
ARCHIVED v3.0 REQUIREMENTS — snapshot taken at milestone close 2026-08-24.

Outcomes:
  - 26 of 27 v3.0 requirements SATISFIED.
  - 1 ACCEPTED-PARTIAL: SCALE-05 (headline IEEE-8500 fixture OOM-bounded; accepted by the
    researcher as an honest non-measurement — see v3.0-MILESTONE-AUDIT.md).
  - SCALE-04 was flagged BLOCKED by the phase verifier on 2026-08-22 and CLOSED on 2026-08-24
    once it was established that plan 25-08 had already produced 9 real SCS solves hours after
    that verification was written. Verdict: NO Clarabel-vs-SCS crossover exists in the measured
    range (ieee13 x4 densities, ieee123 x4, ieee8500-mv @0.1) — Clarabel is OPTIMAL, exact and
    faster at every measured point. Stated as the honest answer with the covered range named,
    NOT extrapolated to the headline fixture. See 25-SCALE-04-CLOSURE.md.
  - No requirement was dropped or silently rewritten during the milestone.

Deferred to a future milestone (NOT counted against v3.0):
  - SCALE-STRETCH — performance/memory-footprint engineering driven by the Phase 25 measurements.
    Deliberately separated: Phase 25 measures and characterizes the wall; optimizing it is
    separate work and must not be entangled with the benchmark that justifies it.
-->
