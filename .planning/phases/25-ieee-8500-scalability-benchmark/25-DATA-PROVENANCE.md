...
**Fetched:** 2026-08-20 (ref `master`, not a pinned commit — pin a commit SHA when vendoring)
...
Still to fetch when vendoring: `Triplex_Linecodes.dss` (triplex Ohm matrices — required for the LV
rung) and, if bus coordinates are wanted for figures, `Buscoords.dss` (215 KB).
