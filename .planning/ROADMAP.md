...
- [x] 25-04-PLAN.md — FixedCapacitor q-only device + materialize.jl population/registry wiring (real per-load kW, capacitor Aggregators)
...
- [x] 25-06-PLAN.md — Full committed density-sweep results + literate scaling page (docs/literate/ieee8500_scaling.jl)
...
| 25. IEEE-8500 Scale Benchmark | v3.0 | 7/6 | Gaps Found | 2026-08-22 |
